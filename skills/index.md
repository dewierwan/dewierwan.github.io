...
- [Brainstorm options](https://dewierwan.com/skills/raw/brainstorm.md): Generate genuinely different options, compare them honestly, and choose the strongest ones.
...
- [Write a case study post](https://dewierwan.com/skills/raw/case-study-post.md): Turn a person's real change into a short, evidence-based case study without exaggerating their story.
...
- [Capture meeting actions](https://dewierwan.com/skills/raw/capture-meeting-actions.md): Review meeting notes, identify genuine commitments, create clear tasks, and ask about uncertain cases.
